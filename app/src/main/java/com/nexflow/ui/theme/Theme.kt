...
// Medium / High contrast schemes — available for accessibility; wired up via
// UiModeManager.getContrast() on API 34+ if desired in future.
internal val mediumContrastLightScheme = lightColorScheme(
...
internal val highContrastLightScheme = lightColorScheme(
...
internal val mediumContrastDarkScheme = darkColorScheme(
...
internal val highContrastDarkScheme = darkColorScheme(
